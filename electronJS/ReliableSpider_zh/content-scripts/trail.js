import { global, clearEl, addEl, LANG } from './global.js';
...
function trial(evt) {
    ...
    // 删除所有class为highlight_of_reliablespider的元素
    let elements = document.getElementsByClassName('highlight_of_reliablespider');
...
function createNotification(text, type = "info") {
    ...
    notification.className = 'notification_of_reliablespider'; // 使用 class 方便后续添加样式
...
function highlightAt(x, y) {
    ...
    element.className = 'highlight_of_reliablespider'; // 使用 class 方便后续添加样式
...
export { createNotification, trial };
