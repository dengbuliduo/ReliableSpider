import './content-scripts/global.js';

{
    document.getElementById('title').innerText = 'Executable Operations';
    document.getElementById('show-toolkit').innerText = 'Show ReliableSpider Toolkit';
    document.getElementById('close-toolkit').innerText = 'Hide ReliableSpider Toolkit';
}
    ...
    const showContainers = (documentRoot) => {
        ...
        containers.forEach(container => {
            if (getComputedStyle(container).display === 'none') {
                ...
                console.log('显示ReliableSpider操作台');
            }
        });
    };
    ...
    const hideContainers = (documentRoot) => {
        ...
        containers.forEach(container => {
            if (getComputedStyle(container).display === 'block') {
                ...
                console.log('关闭ReliableSpider操作台');
            }
        });
    };
