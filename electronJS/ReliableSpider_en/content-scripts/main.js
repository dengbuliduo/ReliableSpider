import { global as global$1, addEl, clearEl, isInIframe, getElementXPaths, readXPath, handleElement, handleDescendents, clearParameters, generateParameters, clearReady, selectAllElements, LANG } from './global.js';
import { collectSingle, collectMultiNoPattern, collectMultiWithPattern, sendSingleClick, sendChangeOption, sendMouseMove, sendLoopMouseMove, sendLoopClickSingle, sendLoopClickEvery, input } from './messageInteraction.js';
...
staticRenderFns: [function(){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('p',{staticStyle:{"color":"black","margin-top":"10px"}},[_vm._v("● 鼠标移动到笑脸"),_c('span',{staticStyle:{"font-size":"20px"}},[_vm._v("☺")]),_vm._v("查看操作提示。")])},function(){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('p',{staticStyle:{"color":"black","margin-top":"10px"}},[_vm._v("●\n            鼠标移动到元素上后，请"),_c('strong',[_vm._v("右键")]),_vm._v("点击或者按"),_c('strong',[_vm._v("F2")]),_vm._v("键选中页面元素。\n          ")])},function(){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('p',{staticStyle:{"color":"black","margin-top":"10px"}},[_vm._v("●\n            通过鼠标左键进行点击时，页面也会有反应，但左键点击发生的操作不会被记录在任务流程中；同理，如果想输入文本框但并不想将动作记录，可以鼠标移动到文本框，并按键盘的"),_c('strong',[_vm._v("F9")]),_vm._v("进行输入。\n          ")])},function(){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('p',{staticStyle:{"color":"black","margin-top":"10px"}},[_vm._v("● 操作完成后，如点击”确认采集“后任务流程图内没有”提取数据“操作被添加，"),_c('strong',[_vm._v("重试一次")]),_vm._v("即可。\n          ")])},function(){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('p',{staticStyle:{"color":"black","margin-top":"10px"}},[_vm._v("● Mouse move to smiling face "),_c('span',{staticStyle:{"font-size":"20px"}},[_vm._v("☺")]),_vm._v(" to see operation help.")])},function(){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('p',{staticStyle:{"color":"black","margin-top":"10px"}},[_vm._v("● When your mouse moves to the element, please\n            "),_c('strong',[_vm._v("right-click")]),_vm._v(" your\n            mouse button or press "),_c('strong',[_vm._v("F2")]),_vm._v(" on the keyboard to select it.")])},function(){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('p',{staticStyle:{"color":"black","margin-top":"10px"}},[_vm._v("● When clicked with the left mouse button, the page will also\n            respond, but this click operation will not be recorded in the task flow. Similarly, if you want to input\n            in a text box but do not want the action to be recorded , you can move the mouse to the text box and\n            press\n            "),_c('strong',[_vm._v("F9")]),_vm._v(" on the keyboard to input.")])},function(){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('p',{staticStyle:{"color":"black","margin-top":"10px"}},[_vm._v("● After the operation is completed, such as if no \"Collect Data\"\n            operation is added in the task flowchart after clicking \"Confirm Collect\", just "),_c('strong',[_vm._v(" retry ")]),_vm._v("\n            again.")])}],
  ...
  methods: {
    ...
    deleteSingleLine: function (event) { //删除单行元素
      ...
      let tnode = global$1.nodeList.splice(index, 1)[0]; //删掉当前元素
      tnode["node"].style.backgroundColor = tnode["bgColor"];
      tnode["node"].style.boxShadow = tnode["boxShadow"];
      if (global$1.nodeList.length > 1) { // 如果删到没有就没有其他的操作了
        handleElement();
    ...
    removeField: function (event) {
      let index = event.target.getAttribute("index");
      let tParameter = global$1.outputParameters.splice(index, 1)[0];
      if (global$1.outputParameters.length == 0) {
        this.valTable = [];
        clearEl();
      } else { //删除对应的列
        console.log("remove:", tParameter, global$1);
        this.valTable.splice(index, 1);
        for (let i = global$1.outputParameterNodes.length - 1; i >= 0; i--) {
          let node = global$1.outputParameterNodes[i];
          if (node["unique_index"] == tParameter["unique_index"]) {
            node["node"].style.backgroundColor = "";
            node["node"].style.boxShadow = "";
            global$1.outputParameterNodes.splice(i, 1);
          }
        }
      }
    },
    clickElement: async function () { //点击元素操作
      sendSingleClick();
      //先发送数据
      global$1.nodeList[0]["node"].focus(); //获得元素焦点
    ...
    changeSelect: function () {
      this.page = 2;
      this.optionMode = 0;
      this.optionValue = global$1.nodeList[0]["node"].options[global$1.nodeList[0]["node"].selectedIndex + 1].text;
    },
    sendChangeSelect: function () {
      ...
      try {
        if (this.optionMode == 0) {
          global$1.nodeList[0]["node"].options[global$1.nodeList[0]["node"].selectedIndex + 1].selected = true;
        } else if (this.optionMode == 1) {
          global$1.nodeList[0]["node"].selectedIndex = this.optionValue;
        } else if (this.optionMode == 2) {
          global$1.nodeList[0]["node"].value = this.optionValue;
        } else if (this.optionMode == 3) {
          global$1.nodeList[0]["node"].options[global$1.nodeList[0]["node"].selectedIndex].selected = true;
          for (let i = 0; i < global$1.nodeList[0]["node"].options.length; i++) {
            const option = global$1.nodeList[0]["node"].options[i];
            if (option.text === this.optionValue) {
              global$1.nodeList[0]["node"].value = option.value; // 将目标选项的值设置为<select>元素的值
              break; // 找到目标选项后跳出循环
            }
          }
        }
    ...
    handleSelectChange: function () {
      ...
      if (this.optionMode == 0) {
        ...
        this.optionValue = global$1.nodeList[0]["node"].selectedIndex;
      } else if (this.optionMode == 2) {
        this.optionValue = global$1.nodeList[0]["node"].value;
      } else if (this.optionMode == 3) {
        this.optionValue = global$1.nodeList[0]["node"].options[global$1.nodeList[0]["node"].selectedIndex].text;
      }
    },
    mouseMove: function () {
      sendMouseMove();
    ...
    getInput: function () { //得到输入的文字
      global$1.nodeList[0]["node"].focus(); //获得文字焦点
      // if (getOS() == "Mac") {
    ...
    setWidth: function (width) { //根据是否出现表格调整最外框宽度
      jquery(".tooltips").css("width", width);
      return "";
    },
    ...
    getSelectedInnerText: function () { //提示文字
      let l = 10;
      return global$1.nodeList[0]["node"].innerText.trim().length > l ? global$1.nodeList[0]["node"].innerText.trim().substring(0, l) + "..." : global$1.nodeList[0]["node"].innerText.trim();
    },
    ...
    tname: function () {
      let tag = global$1.nodeList.length == 0 ? "" : global$1.nodeList[0]["node"].tagName;
      let inputType = global$1.nodeList.length == 0 ? "" : global$1.nodeList[0]["node"].getAttribute("type");
      ...
      if (tag == "") {
        return "null";
      } else if (jquery(global$1.nodeList[0]["node"]).contents().filter(function () {
    ...
    existDescendents: function () { //检测选中的元素是否存在子元素,已经选中了子元素也不要再出现了
      return global$1.nodeList.length > 0 && global$1.nodeList[0]["node"].children.length > 0 && !this.selectedDescendents;
    },
    numOfReady: function () {
      return global$1.readyList.length;
    },
    numOfList: function () {
      return global$1.nodeList.length;
    },
    lastElementXPath: function () { //用来显示元素的最大最后5个xpath路劲元素
      let path = global$1.nodeList[global$1.nodeList.length - 1]["xpath"];
      path = path.split("/");
      let tp = "";
    ...
    enlarge: function () { // 扩大选区功能，总是扩大最后一个选中的元素的选区
      if (global$1.nodeList[global$1.nodeList.length - 1]["node"].tagName != "BODY") {
        global$1.nodeList[global$1.nodeList.length - 1]["node"].style.backgroundColor = global$1.nodeList[global$1.nodeList.length - 1]["bgColor"]; //之前元素恢复原来的背景颜色
        global$1.nodeList[global$1.nodeList.length - 1]["node"].style.boxShadow = global$1.nodeList[global$1.nodeList.length - 1]["boxShadow"]; //之前元素恢复原来的背景颜色
        let tNode = global$1.nodeList[global$1.nodeList.length - 1]["node"].parentNode; //向上走一层
        let sty;
        if (tNode != global$1.NowNode) { //扩大选区之后背景颜色的判断，当前正好选中的颜色应该是不同的
          sty = tNode.style.backgroundColor;
        } else {
          sty = global$1.style;
        }
        global$1.nodeList[global$1.nodeList.length - 1]["node"] = tNode;
        global$1.nodeList[global$1.nodeList.length - 1]["bgColor"] = sty;
        global$1.nodeList[global$1.nodeList.length - 1]["xpath"] = readXPath(tNode, 1);
        global$1.nodeList[global$1.nodeList.length - 1]["allXPaths"] = getElementXPaths(tNode);
        //显示框
        var pos = tNode.getBoundingClientRect();
        global$1.div.style.display = "block";
        global$1.div.style.height = tNode.offsetHeight + "px";
        global$1.div.style.width = tNode.offsetWidth + "px";
        global$1.div.style.left = pos.left + "px";
        global$1.div.style.top = pos.top + "px";
        global$1.div.style.zIndex = 2147483645;
        global$1.div.style.pointerEvents = "none";
    ...
    revoke: function () { //撤销选择当前节点
      let tstep = global$1.step;
      global$1.step--; //步数-1
      console.log(global$1.step, global$1.nodeList);
      while (tstep == global$1.nodeList[global$1.nodeList.length - 1]["step"]) //删掉所有当前步数的元素节点
      {
        let node = global$1.nodeList.splice(global$1.nodeList.length - 1, 1)[0]; //删除数组最后一项
        node["node"].style.backgroundColor = node["bgColor"]; //还原原始属性和边框
        node["node"].style.boxShadow = node["boxShadow"];
        if (global$1.NowNode == node["node"]) {
          global$1.style = node["bgColor"];
        }
        //处理已经有选中子元素的情况
        // if (this.selectedDescendents) {
        clearParameters(); //直接撤销重选
...
//创造div作为选中元素后的样式存在
global$1.div = document.createElement('div');
global$1.div.style.zIndex = "-2147483647";
global$1.div.setAttribute("id", "wrapperDiv");
global$1.div.style.position = "fixed";
global$1.div.style.boxSizing = "border-box";
global$1.div.style.border = "dotted";

global$1.tdiv = document.createElement('div');
global$1.tdiv.style.zIndex = "2147483647";
global$1.tdiv.style.position = "fixed";
global$1.tdiv.setAttribute("id", "wrapperTdiv");
// @ts-ignore
global$1.tdiv.classList = "tdiv";
global$1.tdiv.style.top = "0px";
global$1.tdiv.style.width = "3000px";
global$1.tdiv.style.height = "3000px";
global$1.tdiv.style.pointerEvents = "none";
...
document.addEventListener("mousemove", function() {
    ...
    //如果鼠标在ID为notification_of_reliablespider内则点击和选中失效
    try {
        let notification_of_reliablespider = document.getElementsByClassName("notification_of_reliablespider")[0];
        let x = event.clientX;
        let y = event.clientY;
        let divx1 = notification_of_reliablespider.offsetLeft;
        let divy1 = notification_of_reliablespider.offsetTop;
        let divx2 = notification_of_reliablespider.offsetLeft + notification_of_reliablespider.offsetWidth;
        let divy2 = notification_of_reliablespider.offsetTop + notification_of_reliablespider.offsetHeight;
        if (y >= divy1 - 100 && y <= divy2 + 100) {
            tooltips = true;
            // console.log("notification_of_reliablespider");
            return;
        }
    } catch (e) {

    }
    global$1.oe = document.elementFromPoint(event.x, event.y);
    if (global$1.oe == global$1.tdiv) {
        return;
    }
    tooltips = false;
    global$1.NowNode = global$1.oe;
    let exist = 0;
    let exist2 = 0;
    for (let o of global$1.nodeList) {
        if (o["node"] == global$1.oe) {
            exist = 1;
            break;
        }
    }
    for (let o of global$1.nodeList) {
        if (o["node"] == global$1.xnode) {
            exist2 = 1;
            break;
        }
    }
    // console.log(oe);
    if (global$1.xnode == null) {
        global$1.xnode = global$1.oe;
    }
    if (global$1.xnode != global$1.oe) {
        if (exist2 == 0) { //如果上个元素不在数组里，改回上个元素的初始颜色
            try {
                global$1.xnode.style.backgroundColor = global$1.style; //上个元素改回原来元素的背景颜色
            } catch {
                global$1.xnode.style.backgroundColor = ""; //上个元素改回原来元素的背景颜色
            }
        }

        try {
            global$1.xnode = global$1.oe.style.backgroundColor;
        } catch {
            global$1.xnode = "";
        }
        ...
        if (exist == 1) ; else {
            try {
                global$1.oe.style.backgroundColor = global$1.defaultbgColor; //设置新元素的背景元素
            } catch {

            }
        }
        global$1.xnode = global$1.oe;
        global$1.div.style.display = "none";
    }
...
document.onkeydown = function(event) {
    ...
    if (e && e.keyCode == 113) { // 按 F2
        ...
        global$1.NowNode.focus();
        global$1.NowNode.click();
...
document.body.append(global$1.div); //默认如果toolkit不存在则div和tdiv也不存在
document.body.append(global$1.tdiv);
...
`);
    ...
    // } else{
    global$1.app = new Vue(ToolKit);
    // }

    let h = jquery(".tooldrag").height();
    let difference = 26 - h; //获得高度值差
    if (difference > 0) {
        jquery(".tooldrag").css("cssText", "height:" + (26 + difference) + "px!important");
    }
    //实现提示框拖拽功能
    jquery('.tooldrag').mousedown(function(e) {
        // e.pageX
        var positionDiv = jquery(this).offset();
        ...
        jquery(document).mousemove(function(e) {
            ...
            if (x < 0) {
                x = 0;
            } else if (x > window.innerWidth - jquery('.tooldrag').outerWidth(true)) {
                x = window.innerWidth - jquery('.tooldrag').outerWidth(true);
            }

            if (y < 0) {
                y = 0;
            } else if (y > window.innerHeight - jquery('.tooldrag').outerHeight(true)) {
                y = window.innerHeight - jquery('.tooldrag').outerHeight(true);
            }

            jquery('.tooltips').css({
                'right': window.innerWidth - x - jquery('.tooltips').outerWidth(true) + 'px',
                'bottom': window.innerHeight - y - jquery('.tooltips').outerHeight(true) + 'px',
            });
        });
    ...
    const ReliableSpiderResizer = document.getElementById('ReliableSpiderResizer');

    let mousedown = false;
    let startX, startY, startWidth, startHeight;


    ReliableSpiderResizer.addEventListener('mousedown', e => {
        mousedown = true;
        startX = e.clientX;
        startY = e.clientY;
    ...
    setInterval(function() { //时刻监测相应元素是否存在(防止出现如百度一样元素消失重写body的情况)，如果不存在，添加进来
...
function closeToolkit() {
    ...
    createNotification(LANG("ReliableSpider操作控制台已隐藏，可点击浏览器右上角扩展程序区域的ReliableSpider图标重新显示。", "ReliableSpider Toolkit is hidden. Click the ReliableSpider icon in the extension list (upper right corner) of the browser to reopen."));
}
